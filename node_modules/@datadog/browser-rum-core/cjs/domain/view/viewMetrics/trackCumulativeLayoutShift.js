...
function trackCumulativeLayoutShift(configuration, lifeCycle, viewStart, callback) {
    ...
    var stop = lifeCycle.subscribe(0 /* LifeCycleEventType.PERFORMANCE_ENTRIES_COLLECTED */, function (entries) {
        for (var _i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
            ...
            if (entry.entryType === performanceObservable_1.RumPerformanceEntryType.LAYOUT_SHIFT && !entry.hadRecentInput) {
...
function isLayoutShiftSupported() {
    return (0, performanceObservable_1.supportPerformanceTimingEvent)(performanceObservable_1.RumPerformanceEntryType.LAYOUT_SHIFT);
}
